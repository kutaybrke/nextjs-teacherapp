        ...
        <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 text-center">
                ...
                `}
                            >
                                {isHighlighted && (
                                    <span className="absolute top-2 right-2 bg-white text-blue-600 text-xs px-3 py-1 rounded-full font-semibold shadow-sm">
                                ...
                                <button
                                    className={`mt-8 py-2 px-4 rounded-xl font-semibold transition ${isHighlighted
                                        ? "bg-white text-blue-600 hover:bg-gray-100"
                                        : "bg-blue-600 text-white hover:bg-emerald-700"
                                        }`}
                                >
                                    Paketi Seç
                                </button>
